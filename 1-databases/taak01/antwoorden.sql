...
127.0.0.1/mod_mysql_basic_imdb_movie/movies/		http://localhost/phpmyadmin/sql.php?server=1&db=mod_mysql_basic_imdb_movie&table=movies&pos=0
 Weergave van records 0 - 97 (98 totaal, Query duurde 0,0010 seconden.)
